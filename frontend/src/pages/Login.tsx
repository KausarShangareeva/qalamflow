    ...
    <div className={styles.pageWrapper}>
      <div className={styles.container}>
        ...
        <div className={styles.card}>
          <h1 className={styles.title}>{get("auth.login.title")}</h1>
          {/* <p className={styles.subtitle}>{get("auth.login.subtitle")}</p> */}
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            <div className={styles.inputGroup}>
              <label className={styles.label}>
                {get("auth.login.emailPlaceholder")}
              </label>
            ...
            <div className={styles.inputGroup}>
              <label className={styles.label}>
                {get("auth.login.passwordPlaceholder")}
              </label>
              <div className={styles.inputWrapper}>
          ...
          <p className={styles.link}>
            {get("auth.login.noAccount")}{" "}
            <Link to="/register">{get("auth.login.registerLink")}</Link>
          </p>
        </div>
